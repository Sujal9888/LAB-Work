...
--Select series details, rating and reviewers
SELECT
    series.title,
...
-- INSTEAD OF TYPING ABOVE QUERY ALL THE TIME...WE CAN CREATE A VIEW:

CREATE OR ALTER VIEW full_reviews AS
SELECT
    title,
    released_year,
    genre,
...
select id,title,genre from series
go;
