...
SELECT
    CONCAT_WS('-', title, author_fname, author_lname) as "BookName-Author"
FROM
    books;
...
SELECT
    DISTINCT CONCAT(author_fname, ' ', author_lname) AS FullName
FROM
    books;
